...
from plan import *
SRC="Proposed_Floor_Plan-20260916-R20.pdf"; OUT="Servant_Quarters-SQ-PP-03.pdf"
...
S=Sheet(pg,orig[0])
S.text("SERVANT QUARTERS -",1392.8,648.0,17.09,align="left",fontpath=ARIALB); S.text("GRADE LEVEL LAYOUT",1392.4,668.5,17.09,align="left",fontpath=ARIALB); S.text("SQ-PP-03",1398.1,840.5,14.12,align="left",fontpath=ARIAL)
...
S.text("HOUSE (GROUND FLOOR AT +5'-0\")",300,300,6.0); S.text("KITCHEN OVER THIS STRETCH: THE SERVANT ROOF AT +5'-6\" IS THE KITCHEN GARDEN TERRACE,",300,309,3.6); S.text("ONE RISER ABOVE THE KITCHEN FLOOR, WITH A GLAZED DOOR IN THE OLD WINDOW OPENING,",300,315,3.6); S.text("HERB PLANTERS ON THE PARK WALL AND A PERGOLA OVER (SEE GROUND FLOOR SHEET)",300,321,3.6)
...
def section(x0,ybase,title,deck):
    ...
    if deck:
        ...
        S.wall(x0+12,L(5.5),x0+122,L(5)); S.small("ROOF SLAB, DECK +5'-6\" (1 R ABOVE THE KITCHEN)",x0+72,L(5.5)-4,2.4)
        S.rect(x0+12,L(7.5),x0+34,L(5.5),FURN,0.48); S.small("HERB PLANTER",x0+23,L(7.5)-3,2.0)
        S.line(x0+12,L(13),x0+70,L(13),BLACK,0.72); S.line(x0+40,L(5.5),x0+40,L(13),BLACK,0.48); S.line(x0+66,L(5.5),x0+66,L(13),BLACK,0.48); S.small("PERGOLA +13'-0\"",x0+40,L(13)-3,2.4)
        S.wall(x0+67,L(15.5),x0+122,L(16)); S.small("EXISTING FIRST-FLOOR BALCONY 3'-6\" OVER",x0+95,L(16)-4,2.2)
        ...
        S.line(x0+6,L(5.5),x0+6,L(10),BLACK,0.3); S.small("4'-6\" GUARD",x0-6,L(8),2.0)
...
for t in ["NOTES (SERVANT QUARTERS):","1. EXISTING SERVANT ROOM AND RESTROOM DEMOLISHED; STRIP REBUILT WITH ITS FLOOR AT -3'-0\" THROUGHOUT (RETAINING WALLS, WATERPROOFED, SUMP + PUMP FOR DRAINAGE).",
          ...
          "3. SLEEPING ROOM: ONE DOUBLE BED ACROSS THE SOUTH WALL AND ONE TWO-TIER BUNK ALONG THE HOUSE WALL (4 SLEEPERS), 4'-0\" PASSAGE WITH LOCKERS UNDER THE PARK WINDOW. SINGLE HEIGHT: FLOOR -3'-0\", ROOF SLAB AT +5'-6\" (8'-0\" CLEAR); THE ROOF IS THE KITCHEN GARDEN TERRACE, DESIGNED FOR TERRACE LIVE LOAD AND PLANTERS, WATERPROOFED. LOUVRED VENT HIGH IN THE PARK WALL FOR CROSS-VENTILATION WITH THE DOOR.",
