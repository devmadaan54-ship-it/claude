import pymupdf
src=pymupdf.open("Proposed_Floor_Plan-20260916-R24.pdf"); sq=pymupdf.open("Servant_Quarters-SQ-PP-05.pdf")
out=pymupdf.open()
...
out.save("Proposed_Floor_Plan-20260916-R24-SET.pdf"); print("set", len(out))
