...
from plan import *
SRC="proposed.pdf"; OUT="Proposed_Floor_Plan-20260916-R24.pdf"
...
S.rect(561.6,600,569.1,640,(1,1,1),0,(1,1,1)); S.door(561.4,600,569.3,640,'y1','left'); S.rect(569.6,515,581,585,FURN,0.48); S.small("CONSOLE",575,510,2.0); S.small("BEDROOM-01 ENTRY DOOR 2'-6\"",600,650,2.2); S.small("FROM THE FOYER (LINTEL)",600,655,2.2)
...
for t in ["NOTES (REVISION R3):",
          ...
          "G. ACCESS CHECK, GROUND FLOOR: FRONT DOOR > ENTRANCE FOYER > (WEST) GREAT ROOM AND COURTYARD, (EAST) NEW DOOR INTO THE BEDROOM-01 CLOSET > SLIDING SCREEN > BEDROOM-01 > BATH LOBBY > TOILET. KITCHEN: WEST DOUBLE DOOR FROM THE DINING, EAST GLAZED DOOR TO THE BREAKFAST BAY. POWDER ROOM FROM THE FOYER. SERVANT UNIT FROM THE PORCH END ONLY. BASEMENT FROM THE LIGHT WELL STAIR. NO ROOM IS REACHED THROUGH ANOTHER BEDROOM OR FROM OUTDOORS.",
