...
from plan import *
SRC="proposed.pdf"; OUT="Proposed_Floor_Plan-20260916-R21.pdf"
...
S.window(XW,400,150.5,405.3); S.small("GLASS END WALL, FROSTED TO 5'-0\"",96,412,2.2)
S.line(95.5,215,95.5,400,BLACK,0.3,dashes="[4 2] 0"); S.small("F.F. BALCONY OVER",95.5,222,2.0)
S.rect(XW+4,219,93,396,BLACK,0.48,dashes="[2 2] 0"); S.text("SKYLIGHT",66,300,2.6,vertical=True); S.text("OVER",72,300,2.6,vertical=True)
S.rect(XW+2,215,148.5,231,FURN,0.48); S.line(XW+2,223,148.5,223,FURN,0.24); S.small("BANQUETTE",96,238,2.2)
S.rect(78,246,132,296,FURN,0.48); S.circle(70,258,5); S.circle(70,284,5); S.circle(140,258,5); S.circle(140,284,5)
S.rect(XW+2,360,XW+18,398,FURN,0.48); S.small("SERVERY",XW+10,405-52,2.0)
...
S.text("BREAKFAST BAY",96,300+16,4.6); S.small(dimstr(XW,213,150.5,400),96,306+16,2.8); S.small("GLAZED, AIR-CONDITIONED; FLOOR +5'-6\"",96,311+16,2.6)
S.small("1 R UP FROM THE KITCHEN; CEILING +12'-6\"",96,317+16,2.4); S.small("SKYLIGHT ROOF OVER THE OPEN HALF,",96,322+16,2.4); S.small("SOLID ROOF UNDER THE F.F. BALCONY",96,327+16,2.4); S.small("SERVANT QUARTERS BELOW (SHEET SQ)",96,332+16,2.4)
