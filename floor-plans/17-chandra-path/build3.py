...
from plan import *
SRC="proposed.pdf"; OUT="Proposed_Floor_Plan-20260916-R22.pdf"
...
for t in ["NOTES (REVISION R3):",
          ...
          "C. BEDROOM-01 AS A HOTEL SUITE: FOYER DOOR INTO A WALK-THROUGH CLOSET (WARDROBES BOTH SIDES), SLIDING GLASS SCREEN, THEN THE GARDEN BEDROOM; THE TOILET IS ENTERED FROM INSIDE THE BEDROOM THROUGH A 5'-11\" x 5'-3\" BATH LOBBY WITH VANITY AND LINEN (THE OLD KITCHEN LINK, CLOSED TO THE KITCHEN AND THE GREAT ROOM), 3'-0\" FROM THE BED: BED ON THE SOUTH WALL (HEAD SOUTH), THE EAST WALL BETWEEN PIERS 1 AND 2 FULLY GLAZED ONTO THE PRIVATE GARDEN COURT (NEW RCC LINTEL BEAM BEARING ON THE PIERS, TO STRUCTURAL DESIGN), HIGH-LEVEL WINDOWS IN THE NORTH WALL ONTO THE COVERED PORTE-COCHERE FOR INDIRECT, PRIVATE NORTH LIGHT. COURTYARD-01 IN THE EXISTING STAIRWELL SHAFT, OPEN TO SKY THROUGH ALL FLOORS; THE CENTRE STAYS FREE OF STAIRS. ENTRANCE FLIGHT OUTSIDE THE EXISTING DOOR; BASEMENT STAIR IN THE LIGHT WELL; LIFT GIVES THE STEP-FREE ROUTE.",
