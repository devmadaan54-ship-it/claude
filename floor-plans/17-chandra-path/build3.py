...
from plan import *
SRC="proposed.pdf"; OUT="Proposed_Floor_Plan-20260916-R19.pdf"
...
S.line(298.5,560,298.5,663.9,FURN,0.72); S.line(301.5,560,301.5,663.9,FURN,0.72); S.line(298.5,560,301.5,560,FURN,0.72)
S.rect(298.5,600,301.5,640,BLACK,0.48); S.small("FULL-HEIGHT SLIDING",300,650,2.4); S.small("GLASS SCREEN",300,655,2.4)
S.hatch(170.0,500.7,252.0,527.0); S.hatch(170.0,532.0,196.0,606.0); S.rect(176,640,222,662); S.circle(199,632,6); S.small("DRESSING TABLE",199,668,2.2)
...
S.text("SERVANT",96,300,4.6); S.text("QUARTERS",96,306,4.6); S.small("AT GRADE LEVEL",96,311,2.6); S.small("SEE SEPARATE DRAWING",96,316,2.6); S.small("ROOF +7'-0\" PLANTED, BELOW",96,321,2.4); S.small("THE KITCHEN WINDOW SILL +8'-0\"",96,326,2.4)
...
for t in ["NOTES (REVISION R3):",
          ...
          "C. BEDROOM-01 DAYLIGHT: THE DRESSING-BEDROOM PARTITION IS A FULL-HEIGHT SLIDING GLASS SCREEN, NO WARDROBE ON IT, SO EAST LIGHT FROM THE DRESSING DOOR REACHES THE BED; WARDROBES ON THE DRESSING'S SOUTH AND EAST WALLS. COURTYARD-01 IN THE EXISTING STAIRWELL SHAFT, OPEN TO SKY THROUGH ALL FLOORS: THE CENTRE IS KEPT OPEN AND FREE OF STAIRS. ENTRANCE STEPS ARE A COMPACT 6-RISER FLIGHT OUTSIDE THE EXISTING DOOR; BASEMENT STAIR IN THE WEST PART OF THE EXISTING LIGHT WELL. LIFT GIVES THE STEP-FREE ROUTE.",
          "D. EAST STRIP: SERVANT QUARTERS AT GRADE LEVEL ARE COVERED BY A SEPARATE DRAWING AND ARE NOT SHOWN HERE; THEIR ROOF AT +7'-0\" (PLANTED) SITS BELOW THE KITCHEN EAST WINDOW SILL (+8'-0\", 3'-0\" ABOVE THE KITCHEN FLOOR) SO THE KITCHEN KEEPS ITS WINDOW, CHIMNEY FLUE AND EXHAUST. AT GROUND FLOOR LEVEL THE STRIP CARRIES A BATH DECK AT +60\" WITH THE OUTDOOR SHOWER, TIERED PLANTERS, AND STEPS DOWN FROM THE DRESSING.",
