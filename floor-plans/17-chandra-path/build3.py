...
from plan import *
SRC="proposed.pdf"; OUT="Proposed_Floor_Plan-20260916-R25.pdf"
...
for t in ["NOTES (REVISION R3):",
          ...
          "G. ACCESS CHECK, GROUND FLOOR: FRONT DOOR > ENTRANCE FOYER > GREAT ROOM > VESTIBULE > (SOUTH) KITCHEN, (NORTH) BEDROOM-01 CLOSET > SLIDING SCREEN > BEDROOM-01 > TOILET. KITCHEN > EAST GLAZED DOOR > BREAKFAST BAY. POWDER ROOM FROM THE FOYER. SERVANT UNIT FROM THE PORCH END ONLY. BASEMENT FROM THE LIGHT WELL STAIR. NO ROOM IS REACHED THROUGH ANOTHER BEDROOM OR FROM OUTDOORS.",
