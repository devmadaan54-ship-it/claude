...
from plan import *
SRC="proposed.pdf"; OUT="Proposed_Floor_Plan-20260916-R20.pdf"
...
DEL=[R_(*r) for r in [
    ...
    (250.0,446.0,297.0,501.0),                                    # toilet door from the dressing (closed)
...
S.rect(XW+2,217,XW+24,400,FURN,0.48)
for gy in range(222,400,8): S.line(XW+6,gy,XW+7,gy+1,FURN,0.3); S.line(XW+14,gy+4,XW+15,gy+5,FURN,0.3)
for gx in range(int(XW+30),148,7): S.line(gx,217,gx,400,FURN,0.24)
for gy in (232,262,292,322,352,382): S.line(XW+2,gy,148.5,gy,BLACK,0.3,dashes="[2 2] 0")
S.circle(112,262,11,FURN,0.48); S.circle(112,244,5,FURN,0.48); S.circle(112,280,5,FURN,0.48)
...
S.rect(58,308,146,351,(1,1,1),0,(1,1,1)); S.text("KITCHEN",96,300+16,4.6); S.text("GARDEN TERRACE",96,306+16,4.6); S.small(dimstr(XW+24,217,148.5,400)+" DECK AT +5'-6\"",96,311+16,2.6)
S.small("HERB PLANTERS ON THE PARK WALL",96,317+16,2.4); S.small("PERGOLA OVER THE OPEN HALF; FIRST-FLOOR",96,322+16,2.4); S.small("BALCONY 3'-6\" OVER THE HOUSE HALF",96,327+16,2.4); S.small("SERVANT QUARTERS BELOW (SHEET SQ)",96,332+16,2.4)
...
S.text("BEDROOM",78,420,4.6); S.text("GARDEN COURT",78,426,4.6); S.small(dimstr(XW,405.3,150.5,683.6),78,431,2.8); S.small("PLANTERS, TIERED TO GRADE",78,436,2.4); S.small("STEPS DOWN FROM DRESSING",78,441,2.4)
...
for t in ["NOTES (REVISION R3):",
          ...
          "C. BEDROOM-01 AS A HOTEL SUITE: FOYER DOOR INTO A WALK-THROUGH CLOSET (WARDROBES BOTH SIDES, BATH OFF IT), SLIDING GLASS SCREEN, THEN THE GARDEN BEDROOM: BED ON THE SOUTH WALL (HEAD SOUTH), THE EAST WALL BETWEEN PIERS 1 AND 2 FULLY GLAZED ONTO THE PRIVATE GARDEN COURT (NEW RCC LINTEL BEAM BEARING ON THE PIERS, TO STRUCTURAL DESIGN), HIGH-LEVEL WINDOWS IN THE NORTH WALL ONTO THE COVERED PORTE-COCHERE FOR INDIRECT, PRIVATE NORTH LIGHT. COURTYARD-01 IN THE EXISTING STAIRWELL SHAFT, OPEN TO SKY THROUGH ALL FLOORS; THE CENTRE STAYS FREE OF STAIRS. ENTRANCE FLIGHT OUTSIDE THE EXISTING DOOR; BASEMENT STAIR IN THE LIGHT WELL; LIFT GIVES THE STEP-FREE ROUTE.",
          "D. EAST STRIP: SERVANT QUARTERS AT GRADE (SHEET SQ). THEIR ROOF AT +5'-6\" IS THE KITCHEN GARDEN TERRACE, ONE RISER ABOVE THE KITCHEN FLOOR: GLAZED DOOR IN THE OLD WINDOW OPENING, HERB PLANTERS ALONG THE PARK WALL (4'-6\" OF WALL ABOVE THE DECK AS GUARD), PERGOLA OVER THE OPEN HALF (THE EXISTING 3'-6\" FIRST-FLOOR BALCONY COVERS THE HOUSE HALF), SLAB DESIGNED FOR TERRACE LOAD; THE KITCHEN GETS EAST MORNING LIGHT AND CROSS-VENTILATION. NORTH OF IT THE STRIP IS BEDROOM-01'S PRIVATE GARDEN COURT: BATH DECK AT +60\" WITH THE OUTDOOR SHOWER, TIERED PLANTERS, STEPS DOWN FROM THE BEDROOM DOOR.",
